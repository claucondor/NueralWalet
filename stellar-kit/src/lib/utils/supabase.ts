...
const supabaseUrl = process.env.SUPABASE_URL || 'https://osuxdxzrnnmuvfoonmio.supabase.co';
const supabaseKey = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zdXhkeHpybm5tdXZmb29ubWlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDMwMzIwMzcsImV4cCI6MjA1ODYwODAzN30.5RKoUQbQaBUaO6eW3QUlzlTGFISZqWMJ38ARkH2Ast0';
